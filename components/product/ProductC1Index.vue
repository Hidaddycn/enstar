<template>
    <div>
        <div class="px-10">
            <div class="text-3xl font-semibold mt-20">Customer</div>
        ...
        <div  class="px-10 grid md:grid-cols-2 xl:grid-cols-3 gap-8">
...
const teamStories = [
    ...
    },
    {
        ...
        description: 'Celebrating our milestones and accomplishments.ebrating our milestones and accoebrating our milestones and accoebrating our milestones and accoebrating our milestones and accoebrating our milestones and accoebrating our milestones and acco',
        ...
        link: '/blog/team/one.html'
    },
    {
        title: 'Team Culture',
        description: 'Exploring the values and culture that unite us.',
